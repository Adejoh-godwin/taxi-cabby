// ignore_for_file: avoid_print, use_build_context_synchronously, prefer_collection_literals
...
import 'package:cabby/driver/Assistants/mapkitassistant.dart' as map;
...
class NavigateToUser extends StatefulWidget {
  ...
  @override
  NavigateToUserState createState() => NavigateToUserState();
}

class NavigateToUserState extends State<NavigateToUser> {
  ...
  Future<void> getRideLiveLocationUpdates() async {
    ...
    rideStreamSubscription =
      ...
      var rot = map.MapKitAssistant.getMarkerRotation(oldPos.latitude,
      ...
      body: Stack(
        children: [
          GoogleMap(
            ...
            initialCameraPosition: NavigateToUser._kGooglePlex,
